...
void printImageMetaData(ImageMD imageMD) {
    std::cout << "Here are the properties of your image Metadata.... \n";
    std::cout << "File Name: " << imageMD.getFile() << "\n";
    std::cout << "Image Type: " << imageMD.getImgType() << "\n";
    std::cout << "Date Created: " << imageMD.getMonth() << "/" << imageMD.getDay() << "/"
        << imageMD.getYear() << "\n";
    std::cout << "Size in MB: " << imageMD.getSizeMB() << " MB \n";
    std::cout << "Author Name: " << imageMD.getAuthor() << "\n";
    std::cout << "Image Dimensions in PPI (width x height): " << imageMD.getWidth() << " x " << imageMD.getHeight() << "\n";
    std::cout << "Aperture Size: " << imageMD.getASize() << "\n";
    std::cout << "Exposure Time: " << imageMD.getExpTime() << "\n";
    std::cout << "ISO Value: " << imageMD.getIsoValue() << "\n";
